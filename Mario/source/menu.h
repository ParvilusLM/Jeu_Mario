...
private:
    ...
    */
    ...
    sf::Texture m_tMInstructions,m_tMOptions,m_tMSelectNiveau,m_tMCredits,m_tMPause,
        m_tMScores,m_tMJeuEnCours,m_tMFinPartie;

    sf::Texture m_tBMPrincipal,m_tBMInstructions,m_tBMOptions,m_tBMSelectNiveau,m_tBMCredits,m_tBMPause,
